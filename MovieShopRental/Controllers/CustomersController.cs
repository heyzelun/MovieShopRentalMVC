...
namespace MovieShopRental.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Email,Phone")] Customers customers)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Email,Phone")] Customers customers)
        {
            if (id != customers.Id)
            {
                return NotFound();
